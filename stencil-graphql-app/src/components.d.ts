...
declare global {
  ...
  interface HTMLAppTodosElement extends StencilComponents.AppTodos, HTMLStencilElement {}
  ...
  namespace JSX {
    interface IntrinsicElements {
      'app-todos': JSXElements.AppTodosAttributes;
    }
  }
  namespace JSXElements {
    export interface AppTodosAttributes extends HTMLAttributes {
